...
namespace {
    struct BranchBias : public FunctionPass {
        ...
        bool runOnFunction(Function &F) override {
            ...
            Function *update_func = dyn_cast<Function>(M->getOrInsertFunction("updateBranchInfo", Type::getVoidTy(Context), Type::getInt1Ty(Context)));
            Function *print_func = dyn_cast<Function>(M->getOrInsertFunction("printOutBranchInfo", Type::getVoidTy(Context)));
