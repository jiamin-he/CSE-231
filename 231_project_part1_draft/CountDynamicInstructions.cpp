...
namespace {
    struct CountDynamicInstructions : public FunctionPass {
        ...
        bool runOnFunction(Function &F) override {
            ...
            Function *update_func = cast<Function>(M->getOrInsertFunction("updateInstrInfo", Type::getVoidTy(Context), 
                Type::getInt32Ty(Context), Type::getInt32PtrTy(Context), Type::getInt32PtrTy(Context)));
            Function *print_func = cast<Function>(M->getOrInsertFunction("printOutInstrInfo", Type::getVoidTy(Context)));
